...
public class Q3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Q3 - Quem é o responsavel pela parte visual de uma aplicação web?");

        grupo1.add(a1);
        a1.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        a1.setText("Desenvolvedor Front-end");

        grupo1.add(a2);
        a2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        a2.setText("Desenvolvedor Back-end");
